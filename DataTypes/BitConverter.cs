...
namespace Xevle.Core.DataTypes
{
	/// <summary>
	/// BitConverter+
	/// </summary>
	...
	public static class BitConverterPlus
	{
		...
		public static unsafe byte[] GetBytes(UInt128 value)
		{
			...
			return new byte[16] { ptrLow[0], ptrLow[1], ptrLow[2], ptrLow[3], ptrLow[4], ptrLow[5], ptrLow[6], ptrLow[7], ptrHigh[0], ptrHigh[1], ptrHigh[2], ptrHigh[3], ptrHigh[4], ptrHigh[5], ptrHigh[6], ptrHigh[7] };
		}
		...
		public static unsafe byte[] GetBytesSwapped(UInt128 value)
		{
			byte* ptrHigh = (byte*)&value.High;
			byte* ptrLow = (byte*)&value.Low;
			return new byte[16] { ptrHigh[7], ptrHigh[6], ptrHigh[5], ptrHigh[4], ptrHigh[3], ptrHigh[2], ptrHigh[1], ptrHigh[0], ptrLow[7], ptrLow[6], ptrLow[5], ptrLow[4], ptrLow[3], ptrLow[2], ptrLow[1], ptrLow[0] };
		}
		...
		public static bool ToBoolean(byte[] value, int index = 0)
		{
			...
			if (index < 0 || index >= value.Length) throw new ArgumentOutOfRangeException("index", "Must be non-negative and less than the length of value.");
		...
		public static unsafe char ToChar(byte[] value, int index = 0)
		{
			...
			if (index < 0 || index + 2 > value.Length) throw new ArgumentOutOfRangeException("index", "Must be non-negative and less than the length of value minus 1.");
		...
		public static unsafe int ToInt32(byte[] value, int index = 0)
		{
			...
			if (index < 0 || index + 4 > value.Length) throw new ArgumentOutOfRangeException("index", "Must be non-negative and less than the length of value minus 3.");
		...
		public static unsafe long ToInt64(byte[] value, int index = 0)
		{
			...
			if (index < 0 || index + 8 > value.Length) throw new ArgumentOutOfRangeException("index", "Must be non-negative and less than the length of value minus 7.");
		...
		public static unsafe UInt128 ToUInt128(byte[] value, int index = 0)
		{
			...
			if (index < 0 || index + 16 > value.Length) throw new ArgumentOutOfRangeException("index", "Must be non-negative and less than the length of value minus 15.");
		...
		public static byte[] GetBytes(bool[] value, int index = 0, int count = 0)
		{
			...
			if (index < 0 || index > value.Length) throw new ArgumentOutOfRangeException("index", "Must be non-negative and less than or equal to the length of value.");
		...
		public static unsafe char[] ToCharArray(byte[] value, int index = 0, int count = 0)
		{
			...
			fixed(byte* ptr=&value[index]) for (int i = 0; i < count; i++) ret[i] = *((char*)ptr + i);
			return ret;
		}
		...
		public static unsafe short[] ToInt16Array(byte[] value, int index = 0, int count = 0)
		{
			...
			fixed(byte* ptr=&value[index]) for (int i = 0; i < count; i++) ret[i] = *((short*)ptr + i);
			return ret;
		}
		...
		public static unsafe ushort[] ToUInt16Array(byte[] value, int index = 0, int count = 0)
		{
			...
			fixed(byte* ptr=&value[index]) for (int i = 0; i < count; i++) ret[i] = *((ushort*)ptr + i);
			return ret;
		}
		...
		public static unsafe int[] ToInt32Array(byte[] value, int index = 0, int count = 0)
		{
			...
			fixed(byte* ptr=&value[index]) for (int i = 0; i < count; i++) ret[i] = *((int*)ptr + i);
			return ret;
		}
		...
		public static unsafe uint[] ToUInt32Array(byte[] value, int index = 0, int count = 0)
		{
			...
			fixed(byte* ptr=&value[index]) for (int i = 0; i < count; i++) ret[i] = *((uint*)ptr + i);
			return ret;
		}
		...
		public static unsafe long[] ToInt64Array(byte[] value, int index = 0, int count = 0)
		{
			...
			fixed(byte* ptr=&value[index]) for (int i = 0; i < count; i++) ret[i] = *((long*)ptr + i);
			return ret;
		}
		...
		public static unsafe ulong[] ToUInt64Array(byte[] value, int index = 0, int count = 0)
		{
			...
			fixed(byte* ptr=&value[index]) for (int i = 0; i < count; i++) ret[i] = *((ulong*)ptr + i);
			return ret;
		}
		...
		public static unsafe UInt128[] ToUInt128Array(byte[] value, int index = 0, int count = 0)
		{
			...
			fixed(byte* ptr=&value[index]) for (int i = 0; i < count; i++) ret[i] = new UInt128(*((ulong*)ptr + 2 * i + 1), *((ulong*)ptr + 2 * i));
			return ret;
		}
		...
		public static unsafe float[] ToSingleArray(byte[] value, int index = 0, int count = 0)
		{
			...
			fixed(byte* ptr=&value[index]) for (int i = 0; i < count; i++) ret[i] = *((float*)ptr + i);
			return ret;
		}
		...
		public static unsafe double[] ToDoubleArray(byte[] value, int index = 0, int count = 0)
		{
			...
			fixed(byte* ptr=&value[index]) for (int i = 0; i < count; i++) ret[i] = *((double*)ptr + i);
			return ret;
		}
		#endregion
		...
		public static UInt128[] ToUInt128ArraySwapped(byte[] value, int index = 0, int count = 0)
		{
			...
			UInt128[] ret = new UInt128[count];
			for (int i = 0; i < count; i++, index += 16) ret[i] = new UInt128(ToUInt64Swapped(value, index), ToUInt64Swapped(value, index + 8));
		...
		public static string ToString(byte[] value, int index, int length)
		{
			...
			if (length < 0 || index > value.Length - length || length > 715827882) throw new ArgumentOutOfRangeException("length", "Must be non-negative, less than or equal to the length of value minus index and less than 715827883.");
