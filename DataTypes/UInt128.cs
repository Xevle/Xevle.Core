...
namespace Xevle.Core.DataTypes
{
	...
	public struct UInt128 : IEquatable<UInt128>
	{
		...
		public static UInt128 operator&(UInt128 a, UInt128 b)
		{
			return new UInt128(a.High & b.High, a.Low & b.Low);
		}
		...
		/// <param name="b">The 2nd value.</param>
		/// <returns>The <see cref="UInt128"/> result of the bitwise AND operation.</returns>
		public static UInt128 operator&(ushort a, UInt128 b)
		{
			return new UInt128(0, a & b.Low);
		}
		...
		/// <param name="b">The 2nd value.</param>
		/// <returns>The <see cref="UInt128"/> result of the bitwise AND operation.</returns>
		public static UInt128 operator&(byte a, UInt128 b)
		{
			return new UInt128(0, a & b.Low);
		}
		...
		/// <param name="b">The 2nd value.</param>
		/// <returns>The <see cref="UInt128"/> result of the bitwise AND operation.</returns>
		public static UInt128 operator&(long a, UInt128 b)
		{
			return new UInt128(a < 0 ? b.High : 0, (ulong)a & b.Low);
		}
		...
		public static UInt128 operator|(ulong a, UInt128 b)
		{
			return new UInt128(b.High, a | b.Low);
		}
		...
		public static UInt128 operator|(long a, UInt128 b)
		{
			return new UInt128(a < 0 ? 0xFFFFFFFF : b.High, (ulong)a | b.Low);
		}
		...
		public static UInt128 operator^(long a, UInt128 b)
		{
			return new UInt128(a < 0 ? ~b.High : b.High, (ulong)a ^ b.Low);
		}
