...
namespace Xevle.Core.DataTypes
{
	...
	public static class BitOrder
	{
		...
		{
			if (bits < 0 || bits > 8) throw new ArgumentOutOfRangeException("bits", "Must be greater than or equal to zero and less than 9.");
			if (offset < 0 || offset > 7) throw new ArgumentOutOfRangeException("offset", "Must be greater than or equal to zero and less than 8.");
			if (offset + bits > 8) throw new ArgumentOutOfRangeException("bits+offset", "The sum of bits and offset must be less than 9.");

			if (bits == 0 || bits == 1) return value;

			byte val = (byte)(value >> offset);
			byte mask = (byte)(1 << (bits + offset - 1));
			for (int i = 0; i < bits; i++)
			{
				if ((val & 0x1) != 0) value |= mask;
		...
		{
			if (bits < 0 || bits > 16) throw new ArgumentOutOfRangeException("bits", "Must be greater than or equal to zero and less than 17.");
			if (offset < 0 || offset > 15) throw new ArgumentOutOfRangeException("offset", "Must be greater than or equal to zero and less than 16.");
			if (offset + bits > 16) throw new ArgumentOutOfRangeException("bits+offset", "The sum of bits and offset must be less than 17.");
		...
		{
			if (bits < 0 || bits > 32) throw new ArgumentOutOfRangeException("bits", "Must be greater than or equal to zero and less than 33.");
			if (offset < 0 || offset > 31) throw new ArgumentOutOfRangeException("offset", "Must be greater than or equal to zero and less than 32.");
			if (offset + bits > 32) throw new ArgumentOutOfRangeException("bits+offset", "The sum of bits and offset must be less than 33.");
		...
		{
			if (bits < 0 || bits > 64) throw new ArgumentOutOfRangeException("bits", "Must be greater than or equal to zero and less than 65.");
			if (offset < 0 || offset > 63) throw new ArgumentOutOfRangeException("offset", "Must be greater than or equal to zero and less than 64.");
			if (offset + bits > 64) throw new ArgumentOutOfRangeException("bits+offset", "The sum of bits and offset must be less than 65.");
		...
		{
			if (bits < 0 || bits > 128) throw new ArgumentOutOfRangeException("bits", "Must be greater than or equal to zero and less than 129.");
			if (offset < 0 || offset > 127) throw new ArgumentOutOfRangeException("offset", "Must be greater than or equal to zero and less than 128.");
			if (offset + bits > 128) throw new ArgumentOutOfRangeException("bits+offset", "The sum of bits and offset must be less than 129.");
